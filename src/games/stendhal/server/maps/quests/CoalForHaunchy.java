...
Not needed in Groovy - java.util is imported by default*/
...
//Classes are set as public by default in groovy
class CoalForHaunchy extends AbstractQuest {

	/*private static final String QUEST_SLOT = "coal_for_haunchy";
	Groovy doesn't need type definitions*/
	//Semicolons can also be removed
	private static final QUEST_SLOT = "coal_for_haunchy"
	

	// The delay between repeating quests is 48 hours or 2880 minutes
	//private static final int REQUIRED_MINUTES = 2880;
    private static final REQUIRED_MINUTES = 2880

    //Can remove empty brackets following private void offerQuestStep(){
	...
	@Override
	List<String> getHistory(final Player player) {
	...
	@Override
	String getSlotName {QUEST_SLOT}
	//Removed public, return, semicolon, empty bracket
	//Public String getSlotName() {return QUEST_SLOT;}

	@Override
	String getName {"CoalForHaunchy"}

	@Override
	boolean isRepeatable(final Player player) {
		new AndCondition(new QuestStateStartsWithCondition(QUEST_SLOT,"waiting;"),
				new TimePassedCondition(QUEST_SLOT, 1, REQUIRED_MINUTES)).fire(player,null, null)
	}

	@Override
	boolean isCompleted(final Player player) {
		new QuestStateStartsWithCondition(QUEST_SLOT,"waiting;").fire(player, null, null)
	}
	
	@Override
	String getRegion {Region.ADOS_CITY}
	//Removed public, empty brackets, return, and semicolon

	@Override
	String getNPCName {"Haunchy Meatoch"}
}